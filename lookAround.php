...
function lookAround(){
  ...
  //switch statement to be able to look around
  if ($wearing_glasses xor $wearing_contacts) {
    switch ($location) {
      ...
      case "bathroom":
        ...
        break;
      case "woods":
        echo "Wow, its beautiful out here! The woods are always a place to relax and listen to the beauty of nature... so peaceful. What makes it special? All the yummy mushrooms around! You see the path leading back to your cabin's *kitchen*.\n";
        break;
      } 
  } else {
    echo "It's really hard to make out any details...Getting old, can't see!\n";
    } 
}
